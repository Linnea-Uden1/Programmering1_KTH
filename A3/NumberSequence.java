...
public interface NumberSequence
{
    ...
    // The method throws IndexOutOfBoundsException if the
    // position is wrong.
    void insert (int position, double number) throws IndexOutOfBoundsException;
    ...
    void removeAt (int position) throws IndexOutOfBoundsException, IllegalStateException;
